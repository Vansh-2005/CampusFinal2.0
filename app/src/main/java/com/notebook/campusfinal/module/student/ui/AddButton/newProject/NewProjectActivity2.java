...
public class NewProjectActivity2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_new_project2);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(NewProjectActivity2.this,NewProjectActivity.class);
